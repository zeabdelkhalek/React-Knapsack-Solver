...
import { dynamicProgrammingUKP } from "../algorithms/dynamic-programming";
...
class InputSection extends Component {
  ...
  onClick = () => {
    ...
    var bestSolution = dynamicProgrammingUKP({
      bag,
    });
...
class DynamicProgrammingUKP extends Component {
  render() {
    return (
      <div className="container">
        <Jumbotron>
          <h1 className="display-9 text-center">
            Unbounded Knapsack Problem with Dynamic Programming
          </h1>
        </Jumbotron>
        <InputSection />
      </div>
...
export default DynamicProgrammingUKP;
